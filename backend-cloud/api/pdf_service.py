...
class PDFReportGenerator:
    def _draw_page_chrome(self, canvas, doc):
        ...
        canvas.drawString(0.75 * inch, height - 0.65 * inch, "Wellness Screening")
        ...
        canvas.drawString(0.75 * inch, 0.65 * inch, "Generated by Wellness Screening AI")
    ...
    def generate_report(self, patient_data: Dict, explanation: str) -> bytes:
        ...
        doc = SimpleDocTemplate(
            ...
            title="Wellness Screening Summary",
        )
        ...
        story.append(Paragraph("Wellness Screening Summary", title_style))
        ...
        # Format fingerprint patterns string
        whorl = patient_data.get("pattern_whorl", 0)
        loop = patient_data.get("pattern_loop", 0)
        arc = patient_data.get("pattern_arc", 0)
        fp_patterns_str = f"Whorl {whorl}, Loop {loop}, Arc {arc}"

        results_data = [
            ["Screening Results", ""],
            ["Diabetes Risk Score", f"{patient_data['risk_score']:.1%}"],
            ["Risk Level", patient_data["risk_level"]],
            ["Fingerprint Patterns", fp_patterns_str],
            ["Experimental Blood Group", patient_data.get("blood_group", "Not analyzed")],
        ]

...
HOSPITALS_DB = [
    ...
    },
    {
        ...
        "phone": "(045) 652-0030",
        "mobile": ["0998-573-7901", "0917-851-4710", "0923-749-7231", "0945-778-2567"],
        ...
        "google_query": "Apalit Doctor's Hospital Apalit Pampanga",
        "city": "Apalit",
        "verification_status": "verified",
    },
    {
        ...
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/FDHIph/",
        "google_query": "Floridablanca Doctors' Hospital Pampanga",
        "city": "Floridablanca",
        "verification_status": "verified",
    },
    {
        ...
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/Holy-Family-Medical-Center-121444431243938/",
        "google_query": "Holy Family Medical Center Angeles City Pampanga",
        "city": "Angeles",
        "verification_status": "verified",
    },
    {
        ...
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/Arayat-District-Hospital-1876055656000664/",
        "google_query": "Arayat District Hospital Pampanga",
        "city": "Arayat",
        "verification_status": "verified",
    },
    {
        ...
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/Escolastica-Romero-District-Hospital-109653272396976/",
        "google_query": "Escolastica Romero District Hospital Lubao Pampanga",
        "city": "Lubao",
        "verification_status": "verified",
    },
    {
        "name": "Diosdado P. Macapagal Memorial Hospital",
        "address": "Guagua / Sta. Rita area, Pampanga",
        "type": "Government Hospital",
        "phone": None,
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/Diosdado-P-Macapagal-Memorial-Hospital-235488067000373/",
        "google_query": "Diosdado P Macapagal Memorial Hospital Guagua Pampanga",
        "city": "Guagua",
        "verification_status": "verified",
    },
    {
        ...
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/porac-district-hospital-633478696685857/",
        "google_query": "Porac District Hospital Pampanga",
        "city": "Porac",
        "verification_status": "verified",
    },
    {
        "name": "Balitucan District Hospital (Magalang)",
        "address": "Magalang, Pampanga",
        "type": "Government District Hospital",
        "phone": None,
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/Balitucan-District-Hospital-MAgalangPAmpanga-217437474971458/",
        "google_query": "Balitucan District Hospital Magalang Pampanga",
        "city": "Magalang",
        "verification_status": "verified",
    },
]
...
BLOOD_CENTERS_DB = [
    ...
    },
    {
        ...
        "type": "Blood Drive Venue (check schedule)",
    ...
    # Hospital blood banks / blood services (CALL FIRST to confirm donor acceptance schedule)
    {
        "name": "Jose B. Lingad Memorial General Hospital",
        "address": "Dolores, City of San Fernando, Pampanga",
    ...
    {
        "name": "Our Lady of Mt. Carmel Medical Center - San Fernando",
        "address": "City of San Fernando, Pampanga",
        "type": "Hospital Blood Bank (Call first for donor intake)",
        "phone": None,
        "email": None,
        "website": "https://olmcmc.com/services/san-fernando/clinical-laboratory-department",
        "facebook": None,
        "google_query": "OLMCMC blood bank San Fernando Pampanga",
        "city": "San Fernando",
        "verification_status": "verified",
    },
    {
        ...
        "website": "http://www.aufmc.com.ph/",
        "facebook": None,
        "google_query": "AUFMC blood bank",
        "city": "Angeles",
        "verification_status": "verified",
    },
    {
        "name": "Pampanga Medical Specialist Hospital",
        "address": "Jose Abad Santos Avenue, San Antonio, Guagua, Pampanga 2003",
        "type": "Hospital Services (Call first re: blood donation / blood bank services)",
        "phone": "(045) 455-7674",
        "email": "info@pmsh.com.ph",
        "website": "https://pmsh.com.ph/",
        "facebook": "https://www.facebook.com/PMSHOfficial/",
        "google_query": "Pampanga Medical Specialist Hospital blood bank",
        "city": "Guagua",
        "verification_status": "verified",
    },
    {
        "name": "Apalit Doctor's Hospital Inc.",
        "address": "Gonzales Ave., San Juan, Apalit, Pampanga",
        "type": "Hospital (Call first re: blood donation / blood bank services)",
        "phone": "(045) 652-0030",
        "mobile": ["0998-573-7901", "0917-851-4710", "0923-749-7231", "0945-778-2567"],
        "email": "info@apalitdoctorshospital.com",
        "website": "https://apalitdoctorshospital.com.ph/",
        "facebook": "https://www.facebook.com/apalitdoctors/",
        "google_query": "Apalit Doctor's Hospital blood bank",
        "city": "Apalit",
        "verification_status": "verified",
    },

    # Government hospitals that have held blood donation activities or serve as public hospital hubs
    # (still: CALL FIRST for current blood donation acceptance)
    {
        "name": "Escolastica Romero District Hospital",
        "address": "Lubao, Pampanga",
        "type": "Government Hospital (Call first re: blood donation activities)",
        "phone": None,
        "email": None,
        "website": None,
        "facebook": "https://www.facebook.com/Escolastica-Romero-District-Hospital-109653272396976/",
        "google_query": "Escolastica Romero District Hospital blood donation",
        "city": "Lubao",
        "verification_status": "verified",
    },
    {
        ...
        "website": None,
        "facebook": "https://www.facebook.com/Arayat-District-Hospital-1876055656000664/",
        "google_query": "Arayat District Hospital blood donation",
        "city": "Arayat",
        "verification_status": "verified",
    },
    {
        ...
        "website": None,
        "facebook": "https://www.facebook.com/porac-district-hospital-633478696685857/",
        "google_query": "Porac District Hospital blood donation",
        "city": "Porac",
        "verification_status": "verified",
    },
    {
        ...
        "website": None,
        "facebook": "https://www.facebook.com/Balitucan-District-Hospital-MAgalangPAmpanga-217437474971458/",
        "google_query": "Balitucan District Hospital blood donation",
        "city": "Magalang",
        "verification_status": "verified",
    },
]
...
FACILITIES_DB = {
    ...
    "Angeles": [h for h in HOSPITALS_DB if h.get("city") == "Angeles"],
    "Mabalacat": [h for h in HOSPITALS_DB if h.get("city") == "Mabalacat"],
    "Guagua": [h for h in HOSPITALS_DB if h.get("city") == "Guagua"],
    "Apalit": [h for h in HOSPITALS_DB if h.get("city") == "Apalit"],
    "Lubao": [h for h in HOSPITALS_DB if h.get("city") == "Lubao"],
    "Arayat": [h for h in HOSPITALS_DB if h.get("city") == "Arayat"],
    "Porac": [h for h in HOSPITALS_DB if h.get("city") == "Porac"],
    "Magalang": [h for h in HOSPITALS_DB if h.get("city") == "Magalang"],
    "Floridablanca": [h for h in HOSPITALS_DB if h.get("city") == "Floridablanca"],
}

...
class PatientRecord(models.Model):
    ...
    blood_group = models.CharField(max_length=5, blank=True, null=True) # e.g. "A+", "AB-"
    donation_eligibility_status = models.CharField(max_length=20, blank=True, null=True) # e.g. "Eligible", "Ineligible"

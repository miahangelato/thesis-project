                    ...
                    {activeKeypadName ? (
                      ...
                      <div className="animate-in fade-in duration-300">
                        {willingToDonate === true && (
                          <div className="bg-white rounded-2xl p-5 shadow-lg border-2 border-teal-100 hover:shadow-xl transition-shadow duration-300 select-none">
                            <div className="flex items-center mb-4 pb-3 border-b-2 border-teal-100">
                              <div className="w-10 h-10 bg-linear-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center mr-3 shadow-sm">
                              ...
                              <div>
                                ...
                                <p className="text-slate-600 text-lg">
                                  Help us assess eligibility
                                </p>
                              </div>
                            </div>

                            <p className="text-base text-slate-600 mb-3 italic">
                              These quick questions help us provide safe,
                              general blood donation guidance. Your responses
                              are used only for this session.
                            </p>
                            ...
                            <div className="space-y-3">
                              <div className="space-y-1">
                                ...
                                <Input
                                  ...
                                  readOnly
                                  className={`h-10 text-sm font-semibold rounded-lg border-2 transition-all duration-300 cursor-pointer ${
                                    activeKeypadName === "sleep_hours"
                                      ? "border-teal-500 ring-4 ring-teal-100 bg-teal-50 shadow-lg scale-105"
                                      : formData.sleep_hours
                                ...
                                <p className="text-base text-slate-500 italic">
                                  Adequate rest helps assess readiness for
                                  donation.
                                </p>
                              </div>
                              ...
                              <div className="space-y-1">
                                ...
                                <Input
                                  ...
                                  className="h-9 text-xl rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-0 bg-slate-50 focus:bg-white transition-all"
                                />
                                <p className="text-base text-slate-500 italic">
                                  Used to follow standard donation interval
                                  guidelines.
                                </p>
                              </div>
                              ...
                              <div className="space-y-1">
                                ...
                                <div className="grid grid-cols-2 gap-5 text-lg">
                                  {/* Checkboxes for lifestyle (compact) */}
                                  {[
                                    {
                                      id: "had_alcohol_last_24h",
                                      label: "Alcohol in last 24 hours",
                                    },
                                    {
                                      id: "ate_before_donation",
                                      label: "Ate within 3 hours",
                                    },
                                    {
                                    ...
                                    <div
                                      key={item.id}
                                      className="flex items-start space-x-2 bg-slate-50 p-1 rounded-md hover:bg-slate-100 transition-all"
                                    >
                                      <Checkbox
                                        id={item.id}
                                        checked={
                                        ...
                                        className="border-blue-400 data-[state=checked]:bg-blue-500 h-5 w-5 mt-1"
                                      />
                                      <Label
                                        htmlFor={item.id}
                                        className="text-lg text-slate-700 cursor-pointer leading-tight flex-1"
                                      >
                                        {item.label}
                                      </Label>
                                    </div>
                                ...
                                <p className="text-base text-slate-400 italic mt-2">
                                  ℹ️ These questions do not replace official
                                  donor screening
                                </p>
                              </div>
                            </div>

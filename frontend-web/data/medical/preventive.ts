...
export const preventiveHealthAdvice: PreventiveAdvice[] = [
    ...
    {
        advice:
            "Avoid smoking, limit alcohol consumption, and maintain preventive checkups.",
        source: "CDC",
        details:
    ...
    {
        advice:
            "Stay up to date on recommended vaccinations and cancer screening tests.",
        source: "CDC",
        details:
    ...
    },
    {
        ...
        source: "CDC",
        details:
            "Helps identify early risks and guides prevention strategies."
    },
    {
        advice:
            "Ensure adequate sleep — aim for 7 or more hours per night for adults.",
        source: "CDC",
        details:

          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 bg-teal-100 rounded-full flex items-center justify-center">
                <Fingerprint className="w-7 h-7 text-teal-600" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  Start Automatic Scanning
                </h2>
                <p className="text-sm text-gray-600">10 fingers will be scanned</p>
              </div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800">
                      The scanner will automatically capture each finger and move to the next one after 5 seconds.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-800">
                      Don't worry! You can easily rescan any finger that fails. Just click the "Rescan This Finger" button.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-3">
              ...
              <Button
                onClick={onConfirm}
                className="flex-1 h-12 bg-teal-600 hover:bg-teal-700 text-white font-semibold cursor-pointer"
              >
